...
extern "C" int max__basic_functions_c(int a, int b);
static int max_(int a, int b) {
return max__basic_functions_c(a, b);
}
extern "C" int min_basic_functions_c(int a, int b);
static int min(int a, int b) {
return min_basic_functions_c(a, b);
}
extern "C" int sqr_positive_basic_functions_c(int a);
static int sqr_positive(int a) {
return sqr_positive_basic_functions_c(a);
}
