#ifndef UTBOTCPP_FILESTATSMAP_H
#define UTBOTCPP_FILESTATSMAP_H
...
namespace StatsUtils {
    /*
     * FileStatsMap implements different statistics grouped by file
    ...
    public:
        ...
        explicit FileStatsMap(utbot::ProjectContext projectContext) : projectContext(std::move(projectContext)) {}
